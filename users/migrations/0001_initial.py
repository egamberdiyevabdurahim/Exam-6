    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profession_uz', models.CharField(max_length=128, null=True, verbose_name='Profession')),
                ('profession_ru', models.CharField(max_length=128, null=True, verbose_name='Profession')),
                ('avatar', models.ImageField(default='assets/my/default.jpg', upload_to='team/', verbose_name='Avatar')),
